...
public class Swing extends JFrame implements ActionListener {
    ...
    public Swing() {
        ...
        Color fixedRed = new Color(255, 10, 10);
        Color fixedGreen = new Color(10, 255, 10);
        Color fixedBlue = new Color(10, 10, 255);
        ...
        bgPalette.add(fixedRed);
        bgPalette.add(fixedGreen);
        bgPalette.add(fixedBlue);
        ...
        fgPalette.add(fixedRed);
        fgPalette.add(fixedGreen);
        fgPalette.add(fixedBlue);
